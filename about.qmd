...
<script>
const citations = {
  abnt: 'SILVA, Henrique Alvarenga da. <b>Tipos de Dados em Saúde</b>: Da Coleta à Análise. Publicação independente, 2026. Disponível em: https://henriquealvarenga.com/tiposdedados/',
  vancouver: 'Silva HA. Tipos de dados em saúde: da coleta à análise [Internet]. Publicação independente; 2026 [cited ' + new Date().getFullYear() + ']. Available from: https://henriquealvarenga.com/tiposdedados/',
  apa: 'Silva, H. A. (2026). <i>Tipos de dados em saúde: Da coleta à análise</i>. Publicação independente. https://henriquealvarenga.com/tiposdedados/',
...
const citationsPlain = {
  abnt: 'SILVA, Henrique Alvarenga da. Tipos de Dados em Saúde: Da Coleta à Análise. Publicação independente, 2026. Disponível em: https://henriquealvarenga.com/tiposdedados/',
  vancouver: 'Silva HA. Tipos de dados em saúde: da coleta à análise [Internet]. Publicação independente; 2026 [cited ' + new Date().getFullYear() + ']. Available from: https://henriquealvarenga.com/tiposdedados/',
  apa: 'Silva, H. A. (2026). Tipos de dados em saúde: Da coleta à análise. Publicação independente. https://henriquealvarenga.com/tiposdedados/',
...
::: {.callout-note title="ISBN: (em tramitação)" icon=false}
*Código ISBN e código de barras serão incluídos após registro.*

<!-- Substituir pelo ISBN e imagem do código de barras quando disponíveis:
![](images/barcode.jpeg)
-->
:::
